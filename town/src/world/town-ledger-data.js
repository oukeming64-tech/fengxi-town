(function () {
  ...
  const sourceRefs = [
    "04_AI班级小镇/world/00_source/枫溪镇_黄石农场_世界规则文件_v0.1_原文.md §3.3 每日结算顺序",
    "04_AI班级小镇/world/00_source/枫溪镇_黄石农场_世界规则文件_v0.1_原文.md §6 种植系统",
    "04_AI班级小镇/world/00_source/枫溪镇_黄石农场_世界规则文件_v0.1_原文.md §7 贸易、货币与账务系统",
    "04_AI班级小镇/world/00_source/枫溪镇_黄石农场_世界规则文件_v0.1_原文.md §10.2 事件触发规则",
    "04_AI班级小镇/world/00_source/枫溪镇_行动层规则补丁_v0.2_原文.md §18.1 每日行动生成流程",
    "04_AI班级小镇/world/00_source/枫溪镇_行动层规则补丁_v0.2_原文.md §19.16 系统结算"
  ];
