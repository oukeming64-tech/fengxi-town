(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          market: ["{name}在集市摊前摊开一页收益账，纸角用酒杯压着，说去年那只联营货架翻得漂亮；真正盘货的人还在后排低头算数。", "{name}把几张旧账页压在货篮上，讲得像每个铜板都是自己亲手拨回来的，指甲里却干干净净。"],
          notice: ["{name}在告示牌边把自己的合伙摊写得很亮，旁边小字全留给会计桌，风一吹小字先卷起来。", "{name}把今日成绩贴在最醒目的位置，问到谁在管账时，只说镇上分工本来就要专业。"],
          inn: ["{name}在酒馆举杯讲收益曲线，讲到真正管账的人时，笑着把话题绕到下一轮。", "{name}端着杯子凑到热闹桌边，说联营摊又涨了，手里的杯沿倒先碰了三回。"],
          farm: ["{name}到田边看了一圈，说这季投入要看长线，水桶刚提起来就被别人顺手接过去。"],
          bridge: ["{name}在桥边说修好以后客流会涨，木板刚抬起，就有人替他接了手，他只把袖口又往上卷了一点。"],
