(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          river: ["{name}在河边绕着话问了一圈，真正想知道的事藏在第二句里。", "{name}把热茶递给洗网的人，先问水冷不冷，再问谁刚从会堂回来。"],
          home: ["{name}回住处把窗边的小礼物收起来，没等到回应就不再往外送。", "{name}把多泡的一杯茶倒掉，没有再让人替自己传话。"],
          inn: ["{name}在酒馆听完两种说法，又找第三个人轻轻问了一遍。"],
          market: ["{name}在集市把一小包茶叶换出去，换回来的不是钱，是几句明天的安排。"],
