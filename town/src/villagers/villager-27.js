(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          river: ["{name}沿着河湾跑了三圈，停下第一句先问旁边的人忙不忙。", "{name}把晨跑路线绕到人多的浅滩，喘匀后说自己其实也很懂配速。"],
          market: ["{name}在集市摊前慢跑停步，问摊主忙不忙，又说自己对买卖节奏很有心得。", "{name}帮人递了半篮菜，话头很快拐到自己跑步拿过镇上好成绩。"],
          inn: ["{name}在酒馆门口做拉伸，听见有人聊账本，就说自己在算配速这件事上也算有成就。", "{name}端着水杯凑到热闹桌边，先问大家忙不忙，再讲今天跑了多远。"],
          notice: ["{name}在告示牌旁贴了晨跑路线，旁边又补了一句：有空的人可以一起练。", "{name}看见有人读告示，立刻问人家忙不忙，说自己对这类安排也挺专业。"],
          bridge: ["{name}绕老桥跑了两趟，最后只搬了一根木条，却把桥面坡度讲得很认真。"],
          farm: ["{name}从田埂边跑过，问正在浇水的人忙不忙，脚步没停，建议倒是留了三条。"],
          home: ["{name}回住处擦鞋，把鞋带重新系了两遍，像是在等下一次有人问起晨跑。"]
        };
