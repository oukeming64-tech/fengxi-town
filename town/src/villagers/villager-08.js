(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          home: ["{name}回到小屋后门，把今天谁去了哪里记在口袋本上，铅笔印淡得像怕被人看见。", "{name}在车库门口坐了一会儿，把旧木台阶上的三道裂缝数完，才合上膝上的本子。"],
          river: ["{name}在小溪边钓得很慢，鱼线半天不动，旁边两段闲话倒一字不落地落进耳朵里。", "{name}把鱼线放到香蒲的影子里，别人问起{task}，只答了半句，剩下半句留在水声里。"],
          bridge: ["{name}把一小捆木料放在木桥边，登记时只写了名字，没写自己从哪边扛来的。", "{name}趁桥边人少量了两步距离，等有人喊名字时，已经退到枫树影底下。"],
          farm: ["{name}在社区菜园帮人拔草，草根排得整齐，却始终不往人多的菜畦边挤。"],
          notice: ["{name}在社区公告栏下站了一会儿，铅笔尖都磨钝了，又被他收回夹克口袋。", "{name}听见有人把话说重了，低头把传单的纸角压平，没有马上接话。"]
        };
