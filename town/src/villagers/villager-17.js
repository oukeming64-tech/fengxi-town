(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          river: ["{name}在河边直接问了一句谁明天还来，问完又把话收得很轻。", "{name}把想问的话问到点上，又补了一句不急着答。"],
          inn: ["{name}在酒馆把一句含糊的邀约问清楚，桌上安静了一小会儿。", "{name}听见话里绕弯，便直问是不是今天就定，问完先给对方添了半杯水。"],
          bridge: ["{name}到桥边确认自己只负责哪一段，免得明天临时乱加。"],
          farm: ["{name}在田边把水渠分工问明白，转身就把自己的那段做完。"],
          notice: ["{name}在告示牌前把模糊的字改成两种选项，让迟疑的人自己勾。"],
