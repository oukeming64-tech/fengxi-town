(function () {
  ...
  T.registerVillager(function (name) {
    return T.makeVillager({
      ...
      line(action, ctx) {
        const lines = {
          market: ["{name}拿出一只小风车给摊边的人试，薄木片一转，围观的人先记住了那点沙沙声。", "{name}把新做的小机关摆到集市，讲到卡榫时手指上还沾着木屑，倒不是只会说热闹话。"],
          inn: ["{name}在酒馆拆开一只坏灯，灯油味冒出来，他边擦手边讲这东西还能怎么改。", "{name}听见有人说不结实，没争辩，直接把零件拆开又装了一遍，最后把螺丝放到对方掌心里。"],
          notice: ["{name}把试用结果记在告示牌上，字旁边还画了一个歪歪的小轮架，下面很快有人问要多少木料。"],
          bridge: ["{name}带了个省力的小轮架到桥边，第一根木头滚过去时，抬木的人肩膀终于低了一点。", "{name}把新做的扣环挂到桥绳上，先让旁人拉两下，自己站在旁边听绳子响得顺不顺。"],
          mine: ["{name}进矿洞找能做零件的矿，出来先在石阶上试敲两声，听见脆响才把矿放进袋子。"],
          home: ["{name}回住处把失败的小零件排成一排，桌面被划出细痕，他挑出两个还能再试的留到灯下。"]
        };
